...
const listaDeCategorias = [
  { nome: "Brinquedos", qtd: 32 }, // indice 0 
  { nome: "Roupas", qtd: 30 },
...
const ProductGrid = () => {
    ...
    const totalDePaginas = Math.ceil(todosProdutos.length / produtosPorPagina); // ceil = arredonda para cima  
    const indiceUltimoProduto = paginaAtual * produtosPorPagina; 
    const indicePrimeiroProduto = indiceUltimoProduto - produtosPorPagina; 
    const produtosAtuais = todosProdutos.slice(indicePrimeiroProduto, indiceUltimoProduto); // slice = fatias 
        ...
        <div className='product-grid-container'>
            ...
            <main className='product-list-section'>
                <header className='product-list-header'>
                    <p>Mostrando {indicePrimeiroProduto + 1} até {Math.min(indicePrimeiroProduto, todosProdutos.length)} de {todosProdutos.length} resultado.</p>
